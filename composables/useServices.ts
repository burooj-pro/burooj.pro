...
export const useServices = () => {
  ...
  const services: Service[] = [
      ...
      process: [
        {
          ...
          description: 'We begin by understanding your vision, requirements, budget, and site constraints through detailed consultations and site analysis.',
        },
        {
          title: 'Conceptual Design',
          description: 'Our team develops initial design concepts that align with your goals, incorporating functionality, aesthetics, and regulatory requirements.',
        },
        {
          title: 'Design Development',
          description: 'We refine the chosen concept, develop detailed drawings, and integrate all systems and components into a cohesive design.',
        },
        {
          title: 'Construction Documents',
          description: 'We prepare comprehensive construction documents including detailed drawings, specifications, and permit-ready documentation.',
        },
        {
          title: 'Permit & Approval',
          description: 'We handle all permit applications and coordinate with regulatory authorities to secure necessary approvals.',
        },
        {
          title: 'Construction Support',
          description: 'We provide ongoing support during construction, addressing questions and ensuring design intent is maintained.',
        },
      ],
    ...
    },
    {
      ...
      category: 'Construction & Engineering',
      description: 'Harmonious outdoor environments balancing aesthetics, usability, and sustainability.',
      overview: 'Our landscape design services create beautiful, functional outdoor spaces that enhance property value and provide sustainable, low-maintenance solutions.',
      features: [
        'Site analysis and planning',
        'Plant selection and placement',
        'Hardscape design (paths, patios, structures)',
    ...
    },
    {
      ...
      category: 'Construction & Engineering',
      description: 'Custom-designed furniture that blends craftsmanship with practical comfort.',
      overview: 'We design and create custom furniture pieces that perfectly fit your space, style, and functional needs, combining quality craftsmanship with modern design principles.',
      features: [
      ...
      benefits: [
        ...
        'Cohesive design with overall interior',
    ...
    },
    {
      ...
      category: 'Construction & Engineering',
      description: 'High-efficiency HVAC systems engineered for performance, comfort, and durability.',
      overview: 'We install and maintain HVAC systems that provide optimal climate control, energy efficiency, and long-term reliability for residential, commercial, and industrial properties. Our expert team ensures proper sizing, installation, and ongoing maintenance.',
      features: [
      ...
      process: [
        {
          ...
          description: 'We assess your space, calculate heating and cooling loads, and develop a customized HVAC solution.',
        },
        {
          title: 'System Design',
          description: 'Our engineers design an efficient system layout, select appropriate equipment, and prepare installation plans.',
        },
        {
          title: 'Installation',
          description: 'Our certified technicians install all components with precision, ensuring optimal performance and efficiency.',
        },
        {
          title: 'Testing & Commissioning',
          description: 'We thoroughly test the system, verify performance, and ensure all components operate correctly.',
        },
        {
          title: 'Maintenance Setup',
          description: 'We establish a maintenance schedule and provide you with ongoing support and service programs.',
        },
      ],
      image: '/images/service1.png',
    },
    {
      ...
      title: 'Fire Systems',
      category: 'Construction & Engineering',
      description: 'Firefighting and alarm systems designed and installed according to safety standards.',
      overview: 'We design, install, and maintain comprehensive fire safety systems that protect lives and property while meeting all regulatory requirements and safety standards.',
      features: [
    ...
    },
    {
      ...
      category: 'Construction & Engineering',
      description: 'Safe, reliable electrical installs for residential, commercial, and industrial spaces.',
      overview: 'Our electrical services cover everything from new installations to upgrades and maintenance, ensuring safe, reliable, and code-compliant electrical systems.',
      features: [
    ...
    },
    {
      ...
      category: 'Construction & Engineering',
      description: 'End-to-end plumbing and water system solutions.',
      overview: 'We provide comprehensive plumbing services from installation to maintenance, ensuring reliable water supply, efficient drainage, and long-term system performance.',
      features: [
    ...
    },
    {
      ...
      title: 'Smart Systems',
      category: 'Construction & Engineering',
      description: 'Smart lighting, security, energy-saving, irrigation automation, smart panels, central vacuum, laundry jet, and shading automation.',
      overview: 'We integrate advanced smart systems that automate and optimize building functions, enhancing comfort, security, and energy efficiency.',
      features: [
        'Smart lighting and automation',
        'Security and access control systems',
        'Energy management and monitoring',
        'Irrigation automation',
        'Central vacuum and laundry jet systems',
        'Shading and climate automation',
