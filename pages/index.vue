...
<template>
  ...
  <section ref="clientsSection" class="section-wrapper relative z-30 bg-white">
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
      <div
        ...
        class="group flex min-h-0 min-w-0 items-center justify-center overflow-hidden rounded-lg bg-[#F4F2F2] px-3 py-6 transition-colors sm:px-4 sm:py-8 md:px-6 md:py-10"
      >
        <img
  ...
  >
    {{ hoveredServiceType === 'visit-website' ? t('home.ctaTooltip.visitWebsite') : t('home.ctaTooltip.readMore') }}
  </div>
